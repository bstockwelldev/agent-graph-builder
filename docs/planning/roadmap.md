...
5. **Wave 4 — Resource binding + inspector consolidation.** Linear: [STO-605](https://linear.app/stockwise-productions-prototypes/issue/STO-605).
   ...
   - **4b — Inspector consolidation.** One config-driven resource inspector (Overview/Usage/History) replacing the five duplicated page shells.

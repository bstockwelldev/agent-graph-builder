...
| **P1** | **Studio consolidation Phase 4 — studio app** | High | High | `apps/studio` (Next.js) ported alongside `apps/playground` in sub-phases 4a–4f; parity gate before cutover. 4a (pnpm migration + scaffold) shipped 2026-09-15. |
